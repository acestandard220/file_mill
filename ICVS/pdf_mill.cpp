...
namespace PDFREAD {
    ...
    std::array<const char*, _version_index_last>version_string{ "%PDF-1.0","%PDF-1.2","%PDF-1.4","%PDF-1.7" };
    ...
    void AddFont(int page_num, base_font font, sub_type_index sub_type, encoding encodin)
    {
        ...
        uint32_t new_font_index = global_data.cur_file_read->num_obj++;
